package com.example.a.myapplication12321321.base.permissiongrantutils;
...
/**
 * Created by zhaojihao on 2017-6-17
 * 系统权限分为9大类
 */
...
//                    .show();
    ...
    public static void requestMultiPermissions(final Activity activity, PermissionGrant grant,int[] code) {
        ...
        if (permissionsList.size() > 0) {
            ...
            showMessageOKCancel(activity, "您有一些必要的权限没有开启!现在是否去设置?",
